...
const SEED = [
  ...
  { id:'s05', slug:'vocab-training', title:'职教高考英语词汇练习', summary:'职教高考词汇专项训练（可对外开放）', icon:'📚', cover_color:'#F59E0B', scenario:'教育考试', tech:'低代码(aiforce)', ai_attr:'传统互动Demo', experience_type:'link', external_url:'https://4kxfpv15hpfnf.aiforce.cloud/app/app_17d39m4sd92', cold_start:0, creator:'顾耀飞', rating_avg:4.7, rating_count:34 },
